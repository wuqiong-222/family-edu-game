...
if "page_flag" in st.session_state:
    del st.session_state["page_flag"]
if "animate_playing" in st.session_state:
    del st.session_state["animate_playing"]
